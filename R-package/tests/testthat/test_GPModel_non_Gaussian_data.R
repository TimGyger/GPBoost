...
if(Sys.getenv("GPBOOST_ALL_TESTS") == "GPBOOST_ALL_TESTS"){
  ...
  test_that("FITC for binary classification", {
    ...
    expect_lt(abs(gp_model$get_current_neg_log_likelihood() - nll_mult_exp),TOLERANCE_MEDIUM)
  ...
  test_that("ARD Gaussian process model with linear regression term ", {
    ...
    expect_lt(sum(abs(as.vector(gp_model$get_cov_pars())-cov_pars_est_shape)),TOLERANCE_LOOSE)
